...
# The base manifests/bitcoin.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/bitcoin.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
